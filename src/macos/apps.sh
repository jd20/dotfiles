...
install_apps() {
    ...
    cask_install "Android Studio" "android-studio"
    #cask_install "Atom" "atom"
    cask_install "Audio Hijack" "audio-hijack"
    cask_install "Battle.net" "battle-net"
    ...
    cask_install "Fantastical" "fantastical"
    cask_install "FastRAWViewer" "fastrawviewer"
    cask_install "Figma" "figma"
    cask_install "Handbrake" "handbrake"
    cask_install "Hyper" "hyper"
    cask_install "IconJar" "iconjar"
    mas_install "iFlicks 2" "731062389"
    cask_install "ImageOptim" "imageoptim"
    cask_install "Insomnia" "insomnia"
    cask_install "IntelliJ IDEA CE" "intellij-idea-ce"
    ...
    cask_install "Zeplin" "zeplin"
    cask_install "Zoom" "zoomus"
